...
public class Kalkulator extends JFrame {
    ...
    private JMenu edit;
    private JMenu help;
    private JMenuItem close; // guzik zamknij
    ...
    public static void main(String[] args) throws FileNotFoundException{
        try {
           ...
           System.out.println("Nie mozna wyswietlic wygladu systemowego");
        }
    ...
    private void sendButtons() {
        ...
        equals=new JButton("=");
        equals.setBounds(10,319,137,55);
    ...
    private void sendMenuBar() {
        ...
        view.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "Nie ma pomocnych tematów do wyświetlenia", "Kalkulator",JOptionPane.OK_OPTION);
            }
        });
        about.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null,
                        "Tocki Scipien mistrzowie",
                        "Kalkulator",JOptionPane.OK_OPTION);
            }
        });
    ...
    //okienko
    private void sendUI(Kalkulator app) {
